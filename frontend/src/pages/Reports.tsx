...
const Reports = () => {
    ...
    return (
        <div className="medical-mesh min-h-screen pt-32 pb-24" data-testid="reports-page">
            <div className="container mx-auto px-6 relative">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-slate-500 font-medium tracking-tight max-w-md" data-testid="reports-subtitle">
                    ...
                    >
                        <div className="glass-panel px-6 py-3 flex items-center gap-4">
                            <div className="flex flex-col items-end">
                                ...
                                <span className="text-xl font-black text-navy-900" data-testid="reports-total-count">{totalSymptoms}</span>
                            </div>
                ...
                {/* Reports Grid */}
                <div className="min-h-[600px] relative" data-testid="reports-grid-container">
                    {isLoadingSymptoms ? (
                        <div className="absolute inset-0 flex flex-col items-center justify-center gap-4" data-testid="reports-loading">
                        ...
                        <div className="text-center py-40 glass-panel" data-testid="reports-empty">
                ...
                {totalPages > 1 && (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2" data-testid="reports-page-numbers">
                            {[...Array(totalPages)].map((_, i) => (
                                <button
                                    key={i}
                                    onClick={() => setPage(i + 1)}
                                    data-testid={`reports-page-${i + 1}`}
                                    className={cn(
