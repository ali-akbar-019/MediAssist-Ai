...
const Emergency = () => {
    ...
    return (
        <>
            ...
            <div className="medical-mesh min-h-screen pt-24 sm:pt-28 pb-16 sm:pb-24 overflow-x-hidden">
                <div className="container mx-auto px-4 sm:px-6 relative">
                    ...
                    <div className="max-w-4xl mx-auto mb-10 sm:mb-16">
                        ...
                        >
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-8xl font-black text-navy-900 tracking-tighter leading-none">
                                SYSTEM<span className="text-red-600 block md:inline md:ml-2">CRITICAL</span>
                            </h1>

                            <p className="text-sm sm:text-lg md:text-xl text-slate-500 max-w-xl font-medium leading-relaxed tracking-tight">
                    ...
                    <div className="max-w-5xl mx-auto mb-12 sm:mb-20 relative">
                        ...
                        >
                            <button
                                ...
                                className="group w-full relative aspect-4/5 sm:aspect-21/9 md:aspect-3/1 rounded-[2rem] sm:rounded-[3rem] overflow-hidden shadow-2xl transition-all duration-700 hover:shadow-red-500/10 active:scale-[0.99]"
                            >
                                ...
                                <motion.div
                                    ...
                                    className="absolute inset-x-0 h-40 bg-linear-to-b from-transparent via-red-500/5 to-transparent pointer-events-none z-10"
                                />

                                <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 sm:gap-6 p-5 sm:p-8">
                                    <div className="relative">
                                        <div className="absolute -inset-6 sm:-inset-8 bg-red-500/20 blur-3xl rounded-full animate-pulse" />
                                        <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-red-600 flex items-center justify-center border border-red-400/30 group-hover:bg-red-500 transition-colors duration-500">
                                            <AlertTriangle size={36} className="sm:w-12 sm:h-12 text-white" />
                                        </div>
                                    </div>

                                    <div className="text-center">
                                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-white tracking-tighter uppercase mb-2">
                                            INITIALIZE PROTOCOL
                                        </h2>
                                        <div className="flex items-center justify-center gap-3">
                                            <div className="h-px w-8 bg-white/20" />
                                            <p className="text-[9px] sm:text-[10px] font-bold text-red-400 uppercase tracking-[0.3em] sm:tracking-[0.4em]">
                    ...
                    <div className="max-w-6xl mx-auto grid gap-8 lg:grid-cols-[1fr_1.2fr] lg:gap-12 items-start">
                        ...
                        <div className="space-y-8">
                            <motion.div
                                ...
                                className="glass-panel p-6 sm:p-10 rounded-[2rem] sm:rounded-[3rem] border-white/20 relative overflow-hidden"
                            >
                                        ...
                                        {EMERGENCY_NUMBERS.map((num, i) => {
                                            ...
                                            return (
                                                <motion.a
                                                    ...
                                                    className="group flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-0 p-4 sm:p-6 rounded-2xl bg-white/40 border border-slate-100 hover:border-navy-900/10 hover:bg-white transition-all shadow-sm"
                                                >
                                                    ...
                                                    <ChevronRight size={18} className="self-end sm:self-auto text-slate-300 group-hover:text-navy-900 transition-all group-hover:translate-x-1" />
                                                </motion.a>
                                            );
                                        })}
                                    </div>
                        ...
                        >
                            <div className="flex flex-col sm:flex-row border-b border-slate-100 bg-white/20">
                                {[
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={cn(
                                                "flex-1 flex items-center justify-center gap-2 sm:gap-3 py-4 sm:py-8 text-[10px] sm:text-[11px] font-black uppercase tracking-[0.2em] sm:tracking-[0.25em] transition-all relative overflow-hidden",
                                        ...
                                        {logs.length === 0 ? (
                                            ...
                                            logs.map((log, i) => (
                                                <motion.div
                                                    ...
                                                    className={cn(
                                                        "p-4 sm:p-6 rounded-2xl sm:rounded-3xl border transition-all duration-300",
                                                    ...
                                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6">
                                                        ...
                                                        {!log.resolvedAt && (
                                                            <button
                                                                ...
                                                                className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-navy-900 text-white text-[10px] font-black uppercase tracking-widest hover:bg-navy-950 transition-all shadow-navy active:scale-95 shrink-0 w-full sm:w-auto"
                                                            >
                                                                Clear Protocol
                                                            </button>
                                                        )}
