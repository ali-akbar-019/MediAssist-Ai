    ...
    return (
        ...
        >
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
                ...
                {/* Tab Switcher */}
                <div className="flex justify-center mb-8 sm:mb-12" data-testid="ocr-tabs">
                    <div
                        ...
                        >
                            {currentResult ? (
                                ...
                                <div
                                    ...
                                    data-testid="ocr-upload-container"
                                >
                                    {/* Info Banner */}
                                    <div
