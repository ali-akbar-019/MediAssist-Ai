...
const SystemStatus = ({ icon: Icon, label, status, color }: any) => (
    <div className="flex flex-col gap-3 p-4 rounded-3xl bg-white/40 border border-navy-900/5 group hover:bg-white transition-all duration-500">
        <div className="flex items-center justify-between">
            ...
            <div className="flex gap-0.5">
                {[...Array(3)].map((_, i) => (
                    <div key={i} className={`w-1 h-3 rounded-full ${status === 'Optimal' ? 'bg-emerald-500' : 'bg-slate-100'}`} />
                ))}
            </div>
        </div>
        <div>
            <p className="text-[9px] font-black uppercase tracking-widest text-slate-400 mb-0.5">{label}</p>
            <p className="text-xs font-black text-navy-900">{status}</p>
        </div>
    </div>
);
        ...
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
                ...
                <div className="lg:col-span-4 flex flex-col items-center justify-center border-r border-navy-900/5">
                    ...
                    <div className="mt-8 flex items-center gap-4 bg-navy-900/5 px-6 py-2 rounded-full border border-navy-900/5">
                ...
                <div className="lg:col-span-8 space-y-8">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div className="space-y-2">
                            ...
                            <h2 className="text-4xl font-black text-navy-900 tracking-tighter leading-none">
                        ...
                        <div className="flex flex-col items-end">
                            ...
                            <span className="text-sm font-black text-navy-900 tracking-tight">SIG-{Math.random().toString(36).substring(7).toUpperCase()}</span>
                        </div>
                    </div>
                    ...
                    <div className="p-6 rounded-[2rem] bg-navy-900 text-white relative overflow-hidden shadow-navy group-hover:scale-[1.02] transition-transform duration-500">
                        ...
                        <div className="flex items-start gap-6 relative z-10">
                            ...
                            <div className="space-y-2">
                                <p className="text-xs font-black uppercase tracking-widest text-emerald-400">AI Intelligence Insight</p>
