    ...
    return (
        <div className="space-y-12">
            ...
            <div className="relative pt-4">
                    ...
                    {STEPS.map((step, index) => {
                            ...
                            return (
                                <div key={step.number} className="flex flex-col items-center group">
                                    <div
                                        className={cn(
                                            "w-10 h-10 rounded-2xl flex items-center justify-center text-[13px] font-black tracking-tighter transition-all duration-700 border flex-shrink-0 relative",
                                            isCurrent
                ...
                {currentStep < 4 && (
                    <div className="flex items-center justify-between pt-8 border-t border-white/60">
                        <Button
                            variant="ghost"
                            onClick={currentStep === 1 ? resetAnalyzer : prevStep}
                            className="h-14 px-8 rounded-2xl text-[13px] font-black uppercase tracking-widest text-slate-400 hover:text-navy-900 hover:bg-white/60 transition-all"
                        >
                        ...
                        {currentStep < 3 ? (
                            <Button
                                ...
                                className="h-16 px-12 rounded-2xl bg-navy-900 text-white text-[13px] font-black uppercase tracking-widest hover:bg-navy-950 transition-all shadow-navy"
                            >
                                Continue
